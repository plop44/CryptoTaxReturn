...
namespace Common.Tests
{
    public class FifoAssetTests
    {
        ...
        public void Setup()
        {
            _objectUnderTest= new FifoAsset(new AssetName("Plop"));
        }
        ...
        public void WhenWeGetSellSideAndWeNeedMultipleValues()
        {
            ...
            var assetCost2 = new AssetCost(DateTime.Now.ToUnixDateTime(), 2, 2.2m, source2);
        ...
        public void WhenWeGetSellSideAndWeNeedMultipleValues2()
        {
            ...
            Assert.AreEqual(2.2, sellSideFor[0].CostPerUnit);
